...
.PHONY: all build fuzz eacsl eacsl-build rte val run eacsl-run verify verify-separatedly verify-proved replay replay-separatedly sprove sprove-separatedly clean
