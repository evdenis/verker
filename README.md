...
| 13 | strcspn       | proved | proved         | yes       | yes  |         |
| 14 | strim         |        | not required   | !const    | yes  |         |
| 15 | strlen        | proved | proved         | yes       | yes  |         |
| 16 | strncasecmp   |        |                | yes       | yes  |         |
...
| 26 | strsep        | proved | not required   | !const    | yes  |         |
| 27 | strspn        | proved | proved         | yes       | yes  |         |
| 28 | strstr        |        |                | yes       | yes  |         |
...
[LibFuzzer](http://llvm.org/docs/LibFuzzer.html) - is the library for functions fuzzing. The status of functions fuzzing integration can be viewed in Proofs Status table. It is required to have clang compiler installed and libFuzzer.a in project directory to run fuzzing.
How to run fuzzing:
```
$ make fuzz-<func>
